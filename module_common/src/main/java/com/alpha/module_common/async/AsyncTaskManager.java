...
public class AsyncTaskManager {
     ...
     * @param listener 回调监听
     */
    public void request(int requestCode, IOnDataListener listener){
     ...
     * @param listener 回调监听
     */
    public void request(final int requestCode, final boolean isCheckNetwork, final IOnDataListener listener){
        if(requestCode > 0){
